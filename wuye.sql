...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '123456', '18888888888', 0, '123456@qq.com');
...
CREATE TABLE `building`  (
  ...
  `type` int(10) DEFAULT NULL COMMENT '0：电梯；1：楼梯',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `car`  (
  ...
  `type` int(10) DEFAULT NULL COMMENT '地面或者地下',
  `status` int(10) DEFAULT NULL COMMENT '是否为空',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `gonggao`  (
  ...
  `createBy` int(10) DEFAULT NULL COMMENT '创建者',
  `createTime` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `updateBy` int(10) DEFAULT NULL COMMENT '修改者',
  `updateTime` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `status` int(10) DEFAULT NULL COMMENT '是否展示',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of gonggao
-- ----------------------------
INSERT INTO `gonggao` VALUES (4, '3月收物业费通知', '3月15号之前把物业费交了', 1, '2022-03-01 11:22:30', NULL, NULL, 0);
...
-- Records of repair
-- ----------------------------
INSERT INTO `repair` VALUES (42, '我家的变压器不好了', 1, '1', '2022-03-01 11:24:58', '修好了');
INSERT INTO `repair` VALUES (43, '路砖还没修好', 1, '0', '2022-03-01 11:31:14', NULL);
...
CREATE TABLE `room`  (
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否为空',
  `danyuan_id` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of tousu
-- ----------------------------
INSERT INTO `tousu` VALUES (43, '垃圾桶都满了，没人清理', 1, 1, '2022-03-01 11:24:39', '立马去处理');
INSERT INTO `tousu` VALUES (44, '楼前的路转开了', 1, 0, '2022-03-01 11:30:50', NULL);
...
CREATE TABLE `user_car`  (
  ...
  `inTime` datetime(0) DEFAULT NULL,
  `outTime` datetime(0) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `user_payment` VALUES (5, 2, 1, '100', '2022-03-01 11:22:53', 1);
...
CREATE TABLE `user_room`  (
  ...
  `room_id` int(10) DEFAULT NULL COMMENT '房屋',
  `inTime` datetime(0) DEFAULT NULL COMMENT '入住时间',
  `outTime` datetime(0) DEFAULT NULL COMMENT '离去时间',
  PRIMARY KEY (`id`) USING BTREE,
